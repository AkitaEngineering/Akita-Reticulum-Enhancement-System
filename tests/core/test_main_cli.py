...
class TestMainCli(unittest.TestCase):
    ...
    def test_status_command_includes_runtime_metrics_snapshot(self):
        ...
        self.assertEqual({issue['code'] for issue in payload['health_summary']['issues']}, {'repeated_retry_failures', 'high_proxy_timeout_rate'})
    ...
    def test_status_command_wait_retries_metrics_fetch(self):
        ...
        with patch('akita_ares.core.config_manager.ConfigManager') as config_manager_cls, \
             patch('akita_ares.cli.main_cli.urllib.request.urlopen', side_effect=[OSError('connection refused'), response]) as urlopen, \
